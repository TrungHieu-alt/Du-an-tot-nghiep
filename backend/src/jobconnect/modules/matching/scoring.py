"""Score computation helpers for production matching.

All functions are pure (no I/O, no side effects) and directly unit-testable.

Formula source: docs/REQUIREMENTS.md and production matching HLD.
"""
...
def cosine_similarity(
    ...
    Negative cosine means no positive semantic match in this scoring model, so it
